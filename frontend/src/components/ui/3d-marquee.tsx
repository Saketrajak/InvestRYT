  ...
  return (
    ...
    >
      <div className="flex size-full items-center justify-center">
        <div className="size-[2400px] shrink-0 scale-50 sm:scale-75 lg:scale-100">
          <div
            style={{
              transform: "translate(-50%, -50%) rotateX(55deg) rotateY(0deg) rotateZ(-45deg)",
            }}
            className="absolute top-1/2 left-1/2 grid size-full origin-center grid-cols-5 gap-8 transform-3d"
          >
